...
export default function GalleryCmsShell({
  ...
  const shell = (
    <div className="overflow-hidden bg-white shadow-sm ring-1 ring-slate-200 dark:bg-slate-900 dark:ring-slate-800 lg:rounded-[32px]">
      {header}

      <div className="grid lg:grid-cols-[280px_minmax(0,1fr)_340px]">
        {sidebar}
        {mobileTabs}
        {main}
        {inspector}
