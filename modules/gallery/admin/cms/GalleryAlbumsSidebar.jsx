        ...
        <div className="rounded-[24px] border border-slate-200 bg-slate-50 p-3 dark:border-slate-800 dark:bg-slate-950/40">
          ...
          <div className="mt-3 flex gap-2 overflow-x-auto pb-1">
            <button
              ...
              className="inline-flex h-10 items-center gap-2 whitespace-nowrap rounded-2xl bg-white px-3 text-sm font-medium text-slate-900 ring-1 ring-slate-200 dark:bg-slate-900 dark:text-slate-50 dark:ring-slate-800"
            >
