...
export const isUnclothyGenerated = (photoOrFilename) => {
  ...
  // Blur anything that contains "unclothy" in the original filename (case-insensitive).
  // Examples: "unclothy-123.jpg", "my_UNCLOTHY_result.png"
  return /unclothy/i.test(normalized);
};
...
export const shouldBlurPhoto = (photo, { blurEnabled = true } = {}) => {
  ...
  return isUnclothyGenerated(photo) || photo.nsfwDetected === true;
};
